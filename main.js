...
$(function () {
	...
	var path1 = "https://dl.dropbox.com/s/j1n78bcgyc3jqb3/analects.csv?dl=0";
...
(function () {
	...
	if (SHOWPLAYLIST^button.classList.contains("active")) {
		button.click();
	}
...
ColorsArray = [
	'white', 'silver', 'gray', 'dimgray', 'black',
	'aqua', 'dodgerblue', 'blue', 'midnightblue', 'darkslateblue',
	'lime', 'limegreen', 'green', 'darkgreen', 'darkolivegreen',
	'yellow', 'gold', 'orange', 'orangered', 'tomato',
	'pink', 'PaleVioletRed', 'deeppink', 'red', 'crimson',
	'violet', 'mediumorchid', 'magenta', 'purple', 'darkviolet',
	'papayawhip', 'darkkhaki', 'olive', 'brown', 'saddlebrown',
...
Commands1Array = {
	...
	'f': '<span style="color:#FFFFFF;padding-top:20px; text-shadow:0px 0px 4px #000000, 0px -5px 4px #FFFF33, 2px -8px 6px #FFDD33, -2px -15px 10px #FF8800, 2px -20px 18px #FF2200; letter-spacing:2px">燃</span>',
	'hirogaru': '間',
	'okina': '<span class="cardboardokina">翁</span>',
	'hibana': '<span class="hibanalyrics">ヒ</span>',
	'gs': '灰',
	'rscroll200': '超通過',
	'rscroll': '通過',
	'scroll': '逆通過',
	...
	'round': '往復',
	'round1': '早往復',
	'opa': '<span style="opacity:.25">薄</span>',
	'bl': '<span style="filter:blur(1.5px) contrast(50%)">ぼやけ</span>',
	'br': '<span style="filter:brightness(200%) drop-shadow(0 0 5px #fff)">輝</span>',
	'vib': '<span class="vib">震</span>',
	...
	'yoko': '<span class="m_mark_yoko">横</span>',
	'saka': '<span class="sakasama">逆</span>',
	'usagi': '<span class="pyonpyon">跳</span>',
	'jump': '<span class="haneru">跳</span>',
	'yura': '<span class="yura">揺</span>',
	'yax': '<span class="Yaxisrot">Y軸</span>',
	'blink': '<span class="blink">明滅</span>',
...
Commands2Array = {
	...
	'r!': '<span class="raise">起</span>',
	'a!': '<span class="ayura">揺</span>',
	'Y!': '<span class="yura btcn">揺</span>',
	'!!': '許早苗',
	'b!': 'BB',
	'g!': 'God',
	'N!': '虹',
...
var css = '.bigtitle {\n' +
	...
	'.btn-comando {margin-left:0px !important}\n' +
